      ...
      <div className="container-page relative">
        ...
        <div className="relative mt-16">
          <div className="absolute left-[17px] top-2 h-[calc(100%-1.75rem)] w-px sm:left-[21px]"
            style={{
              backgroundImage:
                "linear-gradient(to bottom, rgba(240,185,11,0.65), rgba(240,185,11,0.18) 60%, rgba(240,185,11,0.04))",
            }}
          />
              ...
              >
                <span className="absolute left-0 top-2">
                  <span className="relative flex h-9 w-9 items-center justify-center sm:h-[52px] sm:w-[52px]">
                    <span className="absolute inset-0 rounded-lg bg-bnb/14 sm:rounded-xl" />
                    <span className="relative h-9 w-9 overflow-hidden rounded-md border border-bnb/45 bg-bg-secondary shadow-card sm:h-[52px] sm:w-[52px] sm:rounded-lg">
                      <Image
                        src={exp.logo}
                        alt={exp.company}
                        fill
                ...
                <div className="card card-hover gold-wrap card-hairline overflow-hidden p-6 sm:p-7">
                  <div className="flex flex-col gap-3 border-b border-border-subtle pb-5 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
                    ...
                    <div className="shrink-0">
                      <span className="relative inline-flex items-center gap-2 rounded-full border border-border bg-bg-tertiary/70 px-3.5 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.16em] text-ink-secondary">
                        <span className="inline-block h-1.5 w-1.5 rounded-full bg-bnb shadow-[0_0_6px_rgba(240,185,11,0.85)]" />
                        {exp.period}
                      </span>
                    </div>
                  </div>
                  ...
                  <ul className="mt-5 space-y-2.5">
                    {exp.highlights.map((h, j) => (
                      ...
                      >
                        <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded bg-bnb/[0.10] text-bnb">
          ...
          <div className="mt-8 flex items-center justify-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-bnb/22 bg-bnb/[0.06] px-5 py-2.5 card-hairline">
              <span className="font-mono text-[11px] font-bold uppercase tracking-[0.2em] text-bnb/90">
                present day
              </span>
              <span className="flex h-2 w-2">
                <span className="absolute inline-flex h-2 w-2 animate-ping rounded-full bg-success opacity-70" />
